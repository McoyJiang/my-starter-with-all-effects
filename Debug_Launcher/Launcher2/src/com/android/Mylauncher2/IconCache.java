...
public class IconCache {
	...
	public Drawable getFullResIcon(Resources resources, int iconId) {
		...
		try {
			...
			if (newIconId > 0) {
				Log.e("JIANG",
						"the newIconId based of newResources is available!!!");
				d = newResources.getDrawableForDensity(newIconId, mIconDpi);
				// d = newResources.getDrawable(newIconId);
			} else {
				Log.e("JIANG",
						"the newIconId based of newResources is not available!!!");
