...
import com.android.Mylauncher2.InstallWidgetReceiver.WidgetMimeTypeHandlerData;
...
public class LauncherModel extends BroadcastReceiver {
	...
	public void loadEffectSettings(Context ctx) {
		...
		if (!oldWorkspaceEffect.equals(mWorkspaceEffect) && callbacks != null) {
			callbacks.onWorkspaceEffectChanged(oldWorkspaceEffect);
		}
	}

	public String getWorkspaceEffect() {
